...
export default function AnimeItem({
  ...
  return (
    <Link href={`/anime/${data.id}`} key={index}>
      <div className="border-2 rounded-md flex flex-col overflow-hidden cursor-pointer hover:border-black transition-all duration-300 ">
